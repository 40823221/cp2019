...
(function dartProgram() {
  ...
  L = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new L.main_closure(tempInput), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
  ...
  L.main_closure.prototype = {
    call$1: function(e) {
      ...
      if (type === "C" || type === "c") {
        t1 = "\u651d\u6c0f " + H.S(number) + " \u5ea6 = \u83ef\u6c0f ";
        if (typeof number !== "number")
          return number.$mul();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSDouble_methods.toStringAsFixed$1(number * 9 / 5 + 32, 2) + " \u5ea6");
      } else {
        t1 = type === "F" || type === "f";
        t2 = output && C.LabelElement_methods;
        if (t1) {
          t1 = "\u83ef\u6c0f " + H.S(number) + " \u5ea6 = \u651d\u6c0f ";
          if (typeof number !== "number")
            return number.$sub();
          t2.setInnerHtml$1(output, t1 + C.JSDouble_methods.toStringAsFixed$1((number - 32) * 5 / 9, 2) + " \u5ea6");
        } else
          t2.setInnerHtml$1(output, "\u8acb\u8f38\u5165\u6578\u5b57\u52a0\u4e0a C \u6216 F!");
      }
      return;
    },
    $signature: 18
...
//# sourceMappingURL=temperature2.js.map
